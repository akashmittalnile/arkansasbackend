                                                            ...
                                                            <div class="pmu-answer-box">
                                                                <div class="pmu-edit-questionnaire-ans">
                                                                    ...
                                                                    <div class="pmu-edit-questionnaire-text">
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Type Here..." name="option[1]"
                                ...
                                <div class="edit-pmu-form-item" id="quiz_div">
                                    <form method="POST" action="{{ route('Home.SaveQuestion') }}" class="pt-4"
                                        ...
                                        <div class="edit-pmu-heading">
                                            ...
                                            <div class="edit-pmu-action">
                                                <a id="addQuestion2"> Add Question</a>
                                                <a href=""> Delete Section</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pmu-answer-option-list questions">
                                            <div class="pmu-answer-box">
                                                <div class="pmu-edit-questionnaire-ans">
                                                    {{-- <div class="pmu-edit-ans-label">
                                                    ...
                                                    <div class="pmu-edit-questionnaire-text">
                                                        <input type="text" class="form-control"
                                                            placeholder="Type Here..." name="option[1]" value="">
                                                        {{-- <span class="remove-text">Remove</span> --}}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="pmu-answer-box">
                                                <div class="pmu-edit-questionnaire-ans">
                                                    ...
                                                    <div class="pmu-edit-questionnaire-text">
                                                        <input type="text" class="form-control"
                                                            placeholder="Type Here..." name="option[2]" value="">
                                                        {{-- <span class="remove-text">Remove</span> --}}
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addQuestionNew').click(function() {
                alert(5);
                var newQuestion = $('.questionLP').first().clone();
                alert(newQuestion);
                newQuestion.find(':input').val('');
                newQuestion.find('input[type="text"]').each(function() {
                    $(this).attr('name', 'questions[' + questionCounter + '][' + $(this).attr('name') + ']');
                });
                newQuestion.appendTo('.questionsLP');
                questionCounter++;
            });
    
            // Add option field
            $(document).on('click', '.add-option', function() {
                var optionField = $('<input type="text" name="questions[' + (questionCounter - 1) + '][options][]" class="form-control" required>');
