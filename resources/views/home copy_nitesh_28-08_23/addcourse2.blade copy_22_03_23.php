...
@section('content')
    ...
    <script>
        $(document).ready(function() {
            ...
            //     var newOption = $(this).siblings('.options').first().clone();
            //     newOption.val('');
            ...
            $(document).on('click', '.add-option', function() {
    var optionsContainer = $(this).siblings('.options'); // Get the options container

    // Create a new div element for the option set
    var newOptionSetDiv = $('<div class="pmu-answer-option-list"></div>');
    var newOptionDivList = $('<div class="pmu-answer-box"></div>');
    var newOptionDiv = $('<div class="pmu-edit-questionnaire-ans"></div>');
    var newOptionDivText = $('<div class="pmu-edit-questionnaire-text"></div>');

    // Clone the option input and add it to the new div
    var newOptionInput = optionsContainer.find('input').first().clone();
    newOptionInput.val('');
    newOptionDivText.append(newOptionInput);

    

    // Append the newOptionDivText to the newOptionDiv
    newOptionDiv.append(newOptionDivText);

    // Append the newOptionDivList to the newOptionDiv
    
    newOptionDivList.append(newOptionDiv);

    // Append the newOptionDivList to the option set
    newOptionSetDiv.append(newOptionDivList);

    // Append the option set div to the options container
    optionsContainer.append(newOptionSetDiv);
    // Append a remove button to the new div
    // var removeOptionButton = $('<button type="button" class="remove-option">Remove Option</button>');
    // newOptionDivText.append(removeOptionButton);
...
$(document).on('click', '.remove-option', function() {
    $(this).closest('.pmu-edit-questionnaire-ans').remove(); // Remove the entire option div
});
            ...
            $(document).on('click', '.remove-option', function() {
                ...
                optionsContainer.last().remove(); // Remove the last option input
