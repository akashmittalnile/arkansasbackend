...
@section('title', 'Makeup University - Listed Course')
@section('content')
            ...
            <div class="pmu-search-filter wd40">
                <div class="row g-2">
                    ...
                    @else
                        <div class="col-md-5">
                            <div class="form-group">
                                <a data-bs-toggle="modal" data-bs-target="#markasactive" class="newcourse-btn">Mark as
                                    Inactive
                                </a>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="becomeacreator-form-info">
                        ...
                        <div class="becomeacreator-btn-action">
                            ...
                            <a href="#" class="cancel-btn" data-bs-dismiss="modal" aria-label="Close">No! Keep it
                                active</a>
                        </div>
                    </div>
                </div>
